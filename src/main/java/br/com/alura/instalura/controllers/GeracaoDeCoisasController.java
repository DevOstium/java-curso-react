...
public class GeracaoDeCoisasController {
	...
	private List<Usuario> geraUsuariosEAmigos() {
		...
		Usuario fagner = new Usuario("fagner", "a","https://biomania.com.br/images/materias/2264/3798585923594400768.jpg");
		...
		//alberto.adicionaAmigo(fagner);
		fagner.adicionaAmigo(vitor);
		...
		return Arrays.asList(alberto,rafael,vitor, fagner);
	}
